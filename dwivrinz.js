...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe DwiVrinz',
			error: {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Jasa Sewa DwiVrinz`, 
                            orderTitle: `Jasa Sewa DwiVrinz`,
...
switch (command) {
	...
	case 'list':
teks = `Hai ${pushname} 👋
Saya ${botname} Whatsapp Yang Menjual Diamond Game ML,FF,dan PUBGM`
img = fs.readFileSync('./dwivrinz/zero.jpg')
trans = ` `
but = [
          { buttonId: `${prefix}listdiamond`, buttonText: { displayText: '💎 LIST DIAMOND' }, type: 1 },
          {buttonId: `${prefix}formatid`, buttonText: { displayText: '📑 FORMAT ORDER' }, type: 1 },
          {buttonId: `${prefix}chiphdi`, buttonText: { displayText: '🎟️ CHIP HDI' }, type: 1 }
...
break
	...
	Jangan Lupa Subscribe DwiVrinz
`
	but = [
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe DwiVrinz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe DwiVrinz`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
dwivrinz.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
fs.unlinkSync(ran)
})
break
...
await dwivrinz.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
break
case 'tiktok':
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
ini_url = args[0]
...
await dwivrinz.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
break
case 'tiktokmusic':
...
await dwivrinz.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
break
...
reply(mess.wait)
dwivrinz.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
})
break
case 'chiisaihentai':
case 'trap':
...
dwivrinz.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
break
case 'asupanhijaber':
...
dwivrinz.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DwiVrinz'})
break
case 'cecanmalaysia':
...
dwivrinz.sendMessage(`6281250436957@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "Silahkan Chat Owner Ya", faketeks, but, mek)
break
case 'permanen':
but = [
 { buttonId: `${prefix}owner`, buttonText: { displayText: '❁ OWNER' }, type: 1 },
...
break
case 'gopay':
sendButton(from, "GOPAY : 0895424490987 (INDRA ARDHIYATMA)", faketeks, but, mek)
break
case 'dana':
sendButton(from, "DANA : 081393024752 (INDRA ARDHIYATMA)", faketeks, but, mek)
break
case 'ovo':
sendButton(from, "OVO : 0895424490987(INDRA ARDHIYATMA)", faketeks, but, mek)
break
case 'donasi':
...
trans = `©Created : DwiVrinz`
list = `✮Price List Diamond ML✮
╭─「  *Mobile Legends Fast A*  」
├❍💎86         =   Rp. 18.875
├❍💎172       =   Rp. 37.750
├❍💎257       =   Rp. 56.280
├❍💎344       =   Rp. 75.430
...
├❍💎6238     =   Rp. 1.264.500
├❍💎9288     =   Rp. 1.857.500
├❍ Starlight    =   Rp. 126.850
├❍ Twilight     =   Rp. 126.850
├❍ Starlight+  =   Rp. 289.500
│ *Proses 1 - 15 Menit*
│ *Maksimal 24 jam*
╰─────────────────
╭─「*Mobile Legends Semi Fast A*」
├❍💎113       =   Rp. 24.600
├❍💎168       =   Rp. 36.500
├❍💎460       =   Rp. 96.500
├❍💎1427     =   Rp. 286.700
...
├❍ Starlight     =  Rp. 98.000
├❍ Twilight      =   Rp.98.000
├❍ Starlight+   =  Rp. 197.000
│ *Proses 10 - 180 Menit*
│ *Maksimal 24 jam ketika orderan*
│ *Overload atau error...*
│ *Open Pukul 09:00 - 19:00*
╰─────────────────
...
*PUBG REG INDO PAKET A* 
*DENOMHARGA PROSES 1-10 MENIT*
*MAX 24 JAM*
•|~~~~~~~~|•
25UC                = Rp 5.700    
36UC                = Rp 7.600     
...
4200UC                = Rp 641.000
8750UC                = Rp 1.279.000 
Royale pass           = Rp 141.000 
Elite Pass plus       = Rp 330.650
•|~~~~~~~~~~~~~~~~~~~~|•

*PUBG REG INDO PAKET B*
*DENOMHARGA OPEN 09.00-19.00*
...
6000uc               = Rp 850.000 
9375uc               = Rp 1.279.000 
46875uc             = Rp 6.380.000
93750uc             = Rp 12.650.000
•|~~~~~~~~~~~~~~~~~~~~|•
...
Gunakan format ini di setiap Transaksi`
sendButImage(from, list, trans, qris, but)
break
